...
class Niti extends StatefulWidget {
  Niti({Key}) : super();
  ...
  @override
  _NitiPageState createState() => _NitiPageState();
}

class _NitiPageState extends State<Niti> {
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.network(
                  'https://jobportall.s3.ap-south-1.amazonaws.com/latestjob/NITI.jpg',
                  height: 40),
              SizedBox(
                width: 30,
              ),

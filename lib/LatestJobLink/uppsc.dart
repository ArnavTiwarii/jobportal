...
class Uppsc extends StatefulWidget {
  Uppsc({Key}) : super();
  ...
  @override
  _UppscPageState createState() => _UppscPageState();
}

class _UppscPageState extends State<Uppsc> {
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.network(
                  'https://jobportall.s3.ap-south-1.amazonaws.com/latestjob/up_logo.jpeg',
                  height: 50),
              SizedBox(
                width: 30,
              ),

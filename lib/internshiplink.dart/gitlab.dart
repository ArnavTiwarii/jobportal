...
class Gitlab extends StatefulWidget {
  ...
  @override
  _GitlabPageState createState() => _GitlabPageState();
}

class _GitlabPageState extends State<Gitlab> {
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.network(
                  'https://jobportall.s3.ap-south-1.amazonaws.com/Internshiplink/logo/gitlab.png',
                  height: 40),
              SizedBox(
                width: 30,
              ),
